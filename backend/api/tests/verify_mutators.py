...
os.environ['SEED_DIR']     = os.path.join(TEST_DATA_ROOT, 'seeds')
os.environ['MUTANT_DIR']   = os.path.join(TEST_DATA_ROOT, 'mutants_llm')
os.environ['GRAMMAR_DIR']  = os.path.join(TEST_DATA_ROOT, 'mutants_grammar')
os.environ['LOGS_DIR']     = os.path.join(TEST_DATA_ROOT, 'logs')
